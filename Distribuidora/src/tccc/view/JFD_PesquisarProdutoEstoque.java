 ...
 * @author Efraim
 */
public class JFD_PesquisarProdutoEstoque extends javax.swing.JDialog {

    PesquisarProdutosEstoqueDAO dao = new PesquisarProdutosEstoqueDAO();
    private int xMouse, yMouse;
    private String nome, id,ValorUnitario,Quantidade,EstoqueMin;
    boolean fechou;
    
    public JFD_PesquisarProdutoEstoque(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dao.ListarTabela2(Tbl);
...
public String getNome() {
    ...
    private void initComponents() {
        ...
        Tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Marca", "Quantidade", "Valor Unitário"
            }
        ) {
    ...
    private void TblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblMouseClicked
        ...
        if (linha != -1) {
            ...
            Quantidade = (Tbl.getValueAt(linha, 3).toString());
            ValorUnitario = (Tbl.getValueAt(linha, 4).toString());
            fechou = true;
            this.dispose();
        }
    ...
    private void BotaoPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoPesquisarMouseClicked
        ...
        switch (CbCampo.getSelectedIndex()) {
            case 1:
            campo = "IdTB_Produto";
            dao.Pesquisar2(campo, TxtPesquisa.getText(), Tbl);
            break;
            case 2:
    ...
    private void CbCampoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CbCampoItemStateChanged
        ...
        try {
            if (CbCampo.getSelectedIndex() == 0) {
                dao.Pesquisar2("IdTB_Produto", "", Tbl);
            }
        } catch (Exception e) {
        }
