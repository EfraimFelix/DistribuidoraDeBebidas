...
import tccc.view.JFD_AlterarPedidoCompra;
import tccc.view.JFD_CadastrarPedidoCompra;
import tccc.view.JFD_VisualizarPedidoCompra;
 ...
 * @author Efraim
 */
public class Painel_TelaPedidoDeCompra extends javax.swing.JPanel {

    PedidoComprarDAO dao = new PedidoComprarDAO();

    public Painel_TelaPedidoDeCompra() {
        initComponents();
        ListarTabela();
    }
    ...
    private void initComponents() {
        ...
        BotaoConfirmar = new javax.swing.JLabel();
        ...
        BotaoConfirmar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tccc/Imagens/icons8_Check_File_65px.png"))); // NOI18N
        ...
        CbCampo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "Telefone", "CEP", "Endereço", "Nº", "Complemento", "Bairro", "Cidade", "UF", "Sexo", "Pessoa", "CPF", "CNPJ", "Nascimento" }));
        ...
        TblPedido.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID Fornecedor", "Fornecedor", "Frete", "Desconto %", "Desconto R$", "Total ", "StatusEntrega", "Hora", "Data"
            }
        ) {
    ...
    private void BotaoNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoNovoMouseClicked
        try {
            ...
            if (System.getProperty("Usuario_TipoConta").equals("Administrador")) {
                JFD_CadastrarPedidoCompra cpc = new JFD_CadastrarPedidoCompra(menu, true, TblPedido);
                cpc.setVisible(true);
            } else {
        ...
        try {
            if (System.getProperty("Usuario_TipoConta").equals("Administrador")) {
                ...
                if (linha != -1) {
                    ...
                    dao.BuscarPedidoComprarID(id, pc);
                    if (pc.getStatus().equals("Entregue")) {
                        JOptionPane.showMessageDialog(null, "Este pedido já foi entregue e não pode ser modificado");
                    } else {
                        Menu menu = new Menu();
                        JFD_AlterarPedidoCompra APC = new JFD_AlterarPedidoCompra(menu,
                                true,
                                TblPedido,
                                id,
                                pc.getId_fornecedor(),
                                pc.getFornecedor_nome(),
                                String.format("%.2f", pc.getFrete()),
                                String.format("%.2f", pc.getDescontoporcentagem()),
                                String.format("%.2f", pc.getDesconto()),
                                String.format("%.2f", pc.getValortotal_pedido()));
                        APC.setVisible(true);
                    }
                } else if (linha != -0) {
    ...
    private void BotaoConfirmarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoConfirmarMouseClicked
        try {
            if (System.getProperty("Usuario_TipoConta").equals("Administrador")) {
                ...
                int Id = 0;
                if (linha != -1) {
                    int res = JOptionPane.showConfirmDialog(null, "Deseja confirma a entrega deste cadastro?! \n Aviso: Cadastros confirmados nao poderão ser alterados", "Aviso", JOptionPane.YES_NO_OPTION);
    ...
    private void BotaoImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoImprimirMouseClicked
        try {
            ...
            pdf.criarPDF(TblPedido, "RelatorioCompras");
            pdf.abrirPDF("RelatorioCompras");
        ...
        try {
            ...
            if (evt.getClickCount() >= 2) {
                ...
                if (linha != -1) {
                    Id = Integer.parseInt(TblPedido.getValueAt(linha, 0).toString());
                    dao.BuscarPedidoComprarID(Id, pc);
                    JFD_VisualizarPedidoCompra VPC = new JFD_VisualizarPedidoCompra(
                            menu,
                            true,
                            String.valueOf(TblPedido.getValueAt(linha, 0)),
                            String.valueOf(pc.getId_fornecedor()),
                            String.valueOf(pc.getFornecedor_nome()),
                            String.valueOf(pc.getData()),
                            String.valueOf(pc.getHora()),
                            String.valueOf(String.format("%.2f", pc.getFrete())),
                            String.valueOf(String.format("%.2f", pc.getDesconto())),
                            String.valueOf(String.format("%.2f", pc.getValortotal_pedido())));
                    VPC.setVisible(true);
                    VPC.setFocusableWindowState(true);
                } else if (linha != -0) {
                    JOptionPane.showMessageDialog(null, "Por favor, clique em algum cadastro");
                }
            }
    ...
    private javax.swing.JLabel BotaoConfirmar;
