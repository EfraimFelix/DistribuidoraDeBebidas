...
import tccc.view.JFD_AlterarProduto;
import tccc.view.JFD_CadastrarProduto;
import tccc.view.Menu;

public class Painel_TelaProduto extends javax.swing.JPanel {

    ProdutoDAO dao = new ProdutoDAO();

    public Painel_TelaProduto() {
        initComponents();
        ListarTabela();
    ...
    private void initComponents() {
        ...
        Tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Marca", "Estoque Mínimo"
            }
        ) {
    ...
    private void BotaoNovo2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoNovo2MouseClicked
        try {
            ...
            if (System.getProperty("Usuario_TipoConta").equals("Administrador")) {
                JFD_CadastrarProduto CP = new JFD_CadastrarProduto(menu, true, Tbl);
                CP.setVisible(true);
            } else {
    ...
    private void BotaoAtualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoAtualizarMouseClicked
        if (System.getProperty("Usuario_TipoConta").equals("Administrador")) {
            try {
                ...
                if (linha != -1) {
                    Id = Integer.parseInt(Tbl.getValueAt(Tbl.getSelectedRow(), 0).toString());
                    dao.BuscarProdutoID(Id, p);
                    System.out.println("Marca Produto - "+ p);
                    JFD_AlterarProduto AP = new JFD_AlterarProduto(
                            menu,
                            true,
                            Tbl,
                            p.getId_produto(),
    ...
    private void BotaoImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoImprimirMouseClicked
        try {
            ...
            pdf.criarPDF(Tbl, "RelatorioProduto");
            pdf.abrirPDF("RelatorioProduto");
    ...
    private void CbCampoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CbCampoItemStateChanged
        ...
        try {
            if (CbCampo.getSelectedIndex() == 0) {
                dao.Pesquisar("IdTB_Produto", "", Tbl);
            }
        } catch (Exception e) {
        }
