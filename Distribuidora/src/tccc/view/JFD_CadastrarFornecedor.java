...
public class JFD_CadastrarFornecedor extends javax.swing.JDialog {

    JXTable Tbl;
    int xMouse, yMouse;
    FornecedorDAO dao = new FornecedorDAO();

    public JFD_CadastrarFornecedor(java.awt.Frame parent, boolean modal, JXTable tb) throws ParseException {
        super(parent, modal);
        initComponents();
        Tbl = tb;
    ...
    private JFD_CadastrarFornecedor(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        lblcadastro.setText("Cadastro de Fornecedor");
