...
public class JFD_CadastrarPedidoCompra extends javax.swing.JDialog {
    ...
    public JFD_CadastrarPedidoCompra(java.awt.Frame parent, boolean modal, JXTable tb) {
        super(parent, modal);
        initComponents();
    ...
    private JFD_CadastrarPedidoCompra(JFrame jFrame, boolean b) {
