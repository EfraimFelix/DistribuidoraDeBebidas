...
public class JFD_CadastrarFuncionario extends javax.swing.JDialog {

    JXTable Tbl;
    FuncionarioDAO dao = new FuncionarioDAO();
    int xMouse, yMouse;
    
    public JFD_CadastrarFuncionario(java.awt.Frame parent, boolean modal, JXTable tb) throws ParseException {
        super(parent, modal);
        initComponents();
    ...
    private JFD_CadastrarFuncionario(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        addcargo = new javax.swing.JLabel();
        ...
        addcargo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tccc/Imagens/icons8_Add_New_24px_2.png"))); // NOI18N
        addcargo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addcargoMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                addcargoMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                addcargoMouseExited(evt);
            }
        });
    ...
    private void addcargoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addcargoMouseClicked
        JFD_AddCargo add = new JFD_AddCargo(null, true, cbcargo);
        add.setVisible(true);
    }//GEN-LAST:event_addcargoMouseClicked

    private void addcargoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addcargoMouseEntered
        addcargo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tccc/Imagens/icons8_Add_New_24px_1.png")));
        addcargo.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }//GEN-LAST:event_addcargoMouseEntered

    private void addcargoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addcargoMouseExited
        addcargo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tccc/Imagens/icons8_Add_New_24px_2.png")));
    }//GEN-LAST:event_addcargoMouseExited
    ...
    private javax.swing.JLabel addcargo;
