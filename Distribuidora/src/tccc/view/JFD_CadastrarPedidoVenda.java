...
public class JFD_CadastrarPedidoVenda extends javax.swing.JDialog {
    ...
    public JFD_CadastrarPedidoVenda(java.awt.Frame parent, boolean modal, JXTable tb) throws ParseException {
        super(parent, modal);
        initComponents();
    ...
    private JFD_CadastrarPedidoVenda(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(Entrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 390, -1, -1));
        ...
        buttonGroup1.add(rbvendaentrega);
